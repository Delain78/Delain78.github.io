class Wave {
  constructor(x, y, w, amplitude, period) {
   ...
   // Where does the wave's first point start
    ...
    // number of circles and making an y value array
    this.yvalues = new Array(floor(this.w / this.xspacing));

    // Value for the angle incrementing for x. Per xspacing the angle will change by dx
  ...
  calculate() {
    // Increment theta or angular velocity
    this.theta += 0.02;
